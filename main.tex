...
\mainmatter
  ...
  \include{chapter/chap-background}
  \include{chapter/chap-design-idea}
  \include{chapter/chap-produce}
  %\include{chapter/chap-Inprovement}
  \include{chapter/chap-summarize}
  %自行添加
  %\include{chapter/...}
